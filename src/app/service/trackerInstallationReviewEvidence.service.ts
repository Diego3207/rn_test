...
import { TrackerInstallationReviewEvidence } from 'src/app/api/trackerInstallationReviewEvidence';
...
export class TrackerInstallationReviewEvidenceService 
{
	bearer:string = "bearer";
    url:string = `${environment.apiUrl}/trackerInstallationReviewEvidence`; 
  ...
  create(data: any){
    return this.http.post<TrackerInstallationReviewEvidence>(this.url+"/add",data);
  }

  delete(id:number){
    const body = { id: id };
    return this.http.put<TrackerInstallationReviewEvidence>(this.url+"/delete",body);
  }
  update(data:any):Observable<any>{
    return this.http.put<TrackerInstallationReviewEvidence>(this.url+"/update",data);
  }
