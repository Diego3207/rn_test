...
@Component({
    templateUrl: './process.quotationSales.component.html'
})
export class ProcessQuotationSalesComponent implements OnInit, OnDestroy {
   ...
   // order: PurchaseOrder;
    ...
    constructor(private miscService:MiscService,private cdref:ChangeDetectorRef ,private purchaseOrderService: PurchaseOrderService, private messageService: MessageService, private confirmationService: ConfirmationService) 
	{
   ...
   delete(deleteType:number, object : PurchaseOrder) {
    ...
    confirmDelete(id:number) {
        this.purchaseOrderService.disable(id).subscribe((data: any)=>{
            this.list();
